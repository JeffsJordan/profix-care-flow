...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ProFix Assistência Técnica" },
      {
        name: "description",
        content:
          "Sistema da ProFix para ordens de serviço, estoque de peças, caixa e relatórios de assistência técnica.",
      },
      { property: "og:title", content: "ProFix Assistência Técnica" },
      {
        property: "og:description",
        content: "Gestão completa de ordens de serviço, estoque e faturamento da ProFix.",
      },
